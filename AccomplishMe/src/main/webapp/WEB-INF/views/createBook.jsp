...
<body>
	<h1 style="margin-top:50px; color: white;">Add New Book</h1>
	<form id="myForm" action="createDetail.cld" method="POST">
	  <h1>Book Form</h1>
	  <!-- One "tab" for each step in the form: -->
	  <div class="tab">Book Info:
	    <p><input placeholder="Name..." name="name"></p>
	    <p><input placeholder="Description..." name="description"></p>
	    <p><input placeholder="Number Pages..." name="numberPages"></p>
	      <input hidden="true" value="book" name ="categoryName">
	  </div>
	    <!-- <div class="tab">
	    </div> -->
